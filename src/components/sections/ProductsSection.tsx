...
export const ProductsSection = () => {
  ...
  // Event Handlers untuk Drag dengan Kursor Mouse
  ...
  return (
    <section id="produk" className="py-20 bg-white text-black overflow-hidden">
      <FadeIn className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        {/* Carousel Slider Horizontal 3D Coverflow */}
        <div className="relative group/carousel px-2 sm:px-4">
          ...
          <div
            ...
            className={`flex overflow-x-auto gap-4 sm:gap-6 py-8 items-center snap-x snap-mandatory scroll-smooth hide-scrollbar px-[calc(50%-140px)] sm:px-[calc(50%-160px)] select-none ${
            ...
            {filteredProducts.map((product, index) => {
              ...
              return (
                <div
                  ...
                  className={`shrink-0 w-70 sm:w-[320px] lg:w-85 snap-center bg-[#f4fdec] rounded-3xl overflow-hidden transition-all duration-500 ease-out flex flex-col justify-between group cursor-pointer ${
                    isActive
                      ? 'scale-105 sm:scale-108 z-20 opacity-100 shadow-2xl ring-4 ring-emerald-600/30'
