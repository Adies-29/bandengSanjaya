      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-3">
          <h2 className="text-2xl sm:text-3xl font-bold text-black">
            Produk {STORE_CONFIG.name}
          </h2>
          <p className="text-gray-600 text-sm sm:text-base max-w-xl mx-auto">
            Olahan higienis siap saji dengan bumbu rempah khas yang meresap sempurna. Siap digoreng atau dikukus kapan saja.
          </p>
            ...
            >
                ...
                <div className="relative aspect-4/3 bg-gray-50 overflow-hidden">
                  ...
                  {product.isBestSeller && (
                    <span className="absolute top-3 right-3 bg-amber-400 text-black text-[11px] font-extrabold uppercase px-3 py-1 rounded-full shadow-xs flex items-center gap-1">
                      <Sparkles className="w-3.5 h-3.5 text-black" /> Best Seller
                    </span>
                  )}
              ...
              <div className="p-6 pt-0 space-y-3.5 text-left">
                ...
                >
                  ...
                  <span>Tanya Harga & Order via WA</span>
                </button>
                ...
                <div className="space-y-1.5 pt-1">
                  ...
                  <div className="grid grid-cols-1">
                    ...
                    <a
                      ...
                      className="inline-flex items-center justify-center gap-1.5 bg-white hover:bg-gray-50 border border-gray-200 font-bold py-1 px-1 rounded-xl text-[11px] transition-all duration-200 shadow-2xs hover:shadow-xs"
                      title="Beli di Paxel Market"

                    >
                      <img src={paxelIcon} alt="Paxel Market" className="w-15 h-15 object-contain shrink-0" />
