  ...
  return (
    <footer className="bg-[#ecffdb] text-black pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="lg:col-span-3 space-y-4 text-left">
            ...
            <ul className="space-y-3 text-sm text-black">
              ...
              <li className="flex items-center gap-1">
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" x="1px" y="0px" width="24" height="24" viewBox="0 0 48 48">
              ...
              <li className="flex items-center gap-1">
                <a
                  ...
                  className="inline-flex items-center gap-2 hover:opacity-80 transition-opacity"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" x="1px" y="0px" width="24" height="24" viewBox="0 0 50 50">
        ...
        <div className="text-center pt-6 flex flex-col sm:flex-row items-center justify-center gap-3 text-xs text-gray-500">
          <p>© {currentYear} {STORE_CONFIG.name}. Website by Adies-29.</p>
          <span className="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-semibold bg-emerald-100 text-emerald-800 border border-emerald-300/60 shadow-2xs">
