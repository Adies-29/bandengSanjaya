...
export const Footer = () => {
  ...
  return (
    <footer className="bg-[#ecffdb] text-black pt-10 pb-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-12 gap-6 sm:gap-8">
          ...
          <div className="col-span-2 lg:col-span-4 space-y-3.5 text-left">
            ...
            <div>
              <div className="inline-flex items-center gap-2 rounded-full text-xs font-bold text-emerald-950 bg-emerald-200/10">
                <img src={halalIcon} alt="Halal Indonesia" className="w-8 h-8 object-contain" />
                <span className="text-xs">{t.footer.halalCert}</span>
              </div>
            </div>
          </div>

          <div className="col-span-1 lg:col-span-3 space-y-3 text-left">
            <h4 className="text-xs font-bold text-black tracking-wider uppercase">
              {t.footer.quickNav}
            </h4>
            <ul className="space-y-1.5 text-xs sm:text-sm text-black">
              <li>
          ...
          <div className="col-span-1 lg:col-span-2 space-y-3 text-left">
            <h4 className="text-xs font-bold text-black tracking-wider uppercase">
              {t.footer.ourProducts}
            </h4>
            <ul className="space-y-1.5 text-xs sm:text-sm text-black">
              <li>Bandeng Presto Duri Lunak</li>
              <li>Otak-Otak Bandeng</li>
              <li>Ayam Ungkep Bumbu Rempah</li>
              <li>Pepes Bandeng</li>
            </ul>
          </div>

          <div className="col-span-2 lg:col-span-3 space-y-3 text-left">
            <h4 className="text-xs font-bold text-black tracking-wider uppercase">
              {t.footer.contactUs}
            </h4>
            <ul className="space-y-2 text-xs sm:text-sm text-black">
              ...
              <li className="flex items-center gap-1">
                ...
                >
                  ...
                  <span className="text-black hover:text-amber-700 font-semibold">
              ...
              <li className="flex items-center gap-1">
                <a
                  href={`https://instagram.com/${STORE_CONFIG.socialMedia.instagram.replace('@', '')}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 hover:opacity-80 transition-opacity"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" x="1px" y="0px" width="20" height="20" viewBox="0 0 48 48">
                  ...
                  <span className="text-black hover:text-amber-700">
              ...
              <li className="flex items-center gap-1">
                <a
                  href="https://www.facebook.com/profile.php?id=100054338598086"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 hover:opacity-80 transition-opacity"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" x="1px" y="0px" width="20" height="20" viewBox="0 0 50 50">
                    <path d="M25,3C12.85,3,3,12.85,3,25c0,11.03,8.125,20.137,18.712,21.728V30.831h-5.443v-5.783h5.443v-3.848 c0-6.371,3.104-9.168,8.399-9.168c2.536,0,3.877,0.188,4.512,0.274v5.048h-3.612c-2.248,0-3.033,2.131-3.033,4.533v3.161h6.588 l-0.894,5.783h-5.694v15.944C38.716,45.318,47,36.137,47,25C47,12.85,37.15,3,25,3z"></path>
                  </svg>
                  <span className="text-black hover:text-amber-700">
                    {STORE_CONFIG.socialMedia.facebook}
                  </span>
                </a>
              </li>
            </ul>
        ...
        <div className="text-center pt-4 border-t border-black/10 flex flex-col sm:flex-row items-center justify-center gap-2 text-xs text-gray-600">
          <p>© {currentYear} {STORE_CONFIG.name}. Website by Adies-29.</p>
          <span className="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-semibold text-black">
